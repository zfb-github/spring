...
.Java
----
	public class com.spring.debug.Main {
...
of the `com.spring.debug.Main` class has a reference to the proxy. This means that method calls on that
...
----
	...
	public final class com.spring.debug.Main {

		public static void main(String[] args) {
			ApplicationContext ctx = new ClassPathXmlApplicationContext("beans.xml", com.spring.debug.Main.class);
...
We use the following command to run the `com.spring.debug.Main` class shown earlier:

[literal,subs="verbatim,quotes"]
----
java -javaagent:C:/projects/foo/lib/global/spring-instrument.jar foo.com.spring.debug.Main
----
...
The output from the execution of the `com.spring.debug.Main` program looks something like the next example.
...
Spring beans. The following slight variation on the `com.spring.debug.Main` program yields the same
result:
...
----
	...
	public final class com.spring.debug.Main {
		...
		public static void main(String[] args) {
			new ClassPathXmlApplicationContext("beans.xml", com.spring.debug.Main.class);
